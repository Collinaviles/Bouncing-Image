...
public class Main : SEScene
{
	...
	public void initialize(SEResourceCache rsc) {
		...
		bg.move(0,0);
    	rsc.prepare_image("Koalae","",get_scene_width()*0.1,get_scene_height()*0.1);
        
        fg=add_sprite_for_image(SEImage.for_resource("squirtle"));
        fg.move(100,100);;

		rsc.prepare_image("temp","Koala",get_scene_width()*0.1,get_scene_height()*0.1);
